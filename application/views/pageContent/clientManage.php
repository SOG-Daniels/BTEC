        ...
        <div class="form-group">
            <div class="row ">
                <div class="col-4 col-md-1" >
                    <img class="rounded-circle" src="<?php echo base_url().$this->session->userdata('imgPath');?>" alt="Profile Pic" width="95%" hight="95%">
                </div>
            ...
            foreach ($comments as $commentData){
                ...
                if(!empty($commentData)){
                    ...
                    echo '
                        <div class="row">
                            <div class="col-4 col-md-1" >
                                <img class="rounded-circle" src="'.base_url().$commentData['userProfilePic'].'" alt="Profile Pic" width="100%" hight="100%">
                            </div>
